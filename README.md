...
Last updated: 2026-08-26 (added the dark_enzymes and Rv2438A manuscripts, submitted earlier this month and missing from this index until now).
...
| Title | Description | Access | Status |
|-------|-------------|--------|--------|
| Active-site-constrained structure-guided hypotheses for six uncharacterised enzymes of *Mycobacterium tuberculosis* | A structure-guided pipeline (ESMFold/Foldseek/HHpred/AlphaFold3, gated by active-site competence and paralogue-of-fold cross-checks) generates and stress-tests functional hypotheses for six long-standing hypothetical proteins: three robust requalifications (a circularly permuted NlpC/P60 amidase, a binuclear metallo-beta-lactamase-fold hydrolase, a thymidylate-synthase-superfamily transferase), one weaker candidate, one self-detected false positive corrected by an independent profile-profile search, and one regulator hypothesis independently confirmed after the fact by unrelated published work. Used as a proof-of-concept benchmark for how far structure-guided annotation can go, and where it self-corrects. | [PDF](manuscripts/dark-enzymes-characterisation.pdf) | Submitted to FEMS Microbiology Letters, pending peer review |
| Rv3222c, the unnamed gene between *sigH* and *rshA*, encodes an essential intrinsically disordered protein and is the last intact member of a degenerate gene family in *Mycobacterium tuberculosis* | Rv3222c surfaced from an atlas-wide vulnerability screen as an uncharacterised hypothetical protein physically inserted (4-bp overlaps on both flanks) between the *sigH*-*rshA* oxidative-stress operon. Systematic re-derivation of every inherited claim shows it is essential (Tn-seq, robust to mappability and polarity objections, with a phylogenetic pattern of unequal requirement across lineages), intrinsically disordered (44.8%), under strong purifying selection, has no detectable sequence or structural homolog, and is the last coding survivor of a small gene family degraded across the genus by an ancestral IS110-family insertion. An existing PROSPECT chemogenomic depletion strain makes it experimentally tractable despite the absence of a druggability claim. | [PDF](manuscripts/Rv3222c-characterisation.pdf) | Submitted to Archives of Microbiology, pending peer review |
| Rv0810c: a genus-conserved, structurally ordered small protein of unknown function carrying DUF3073 in *Mycobacterium tuberculosis* | Rv0810c is a 60-residue protein carrying the unknown-function domain DUF3073 (Pfam PF11273), flagged as an Actinobacteria-signature protein in 2006 and never studied since. This manuscript establishes that it is genuinely translated (detected in 11 of 16 proteomic datasets), has no significant human homologue, no overlap with a neighbouring gene, a bipartite architecture (a rigid conserved module followed by an intrinsically disordered acidic tail), strong purifying selection, and conservation without a single confirmed loss across 260 Actinomycetia genera. Eight independent computational strategies converge on the same negative: no assignable fold, binding site, or functional neighbour. Presented as a rigorous negative result rather than a manufactured function. | [PDF](manuscripts/Rv0810c-characterisation.pdf) | Submitted to Proteins: Structure, Function, and Bioinformatics, pending peer review |
| A conserved cysteine-histidine-glutamate metal site identifies DUF501 (Rv1025), an essential uncharacterised protein family of *Mycobacterium tuberculosis*, as a candidate metalloenzyme and drug target | Rv1025 is a 155-residue essential, vulnerable, uncharacterised protein carrying DUF501 (Pfam PF04417), a family with no Gene Ontology term or solved structure anywhere. A structural search finds no homolog, indicating a novel fold; conservation across 8,700 homologous sequences reveals a near-invariant Cys113-His115-Glu59 triad, and holo AlphaFold3 modelling places a divalent metal on this triad with corroboration from an independent, triad-mutant-controlled geometry predictor. The conserved *eno*-*divIC*-*Rv1025*-*ppx2* operon does not correspond to a stable Rv1025-DivIC complex. Proposes DUF501 as a metal-binding candidate metalloenzyme and drug target, the first functional hypothesis for this family. | [PDF](manuscripts/Rv1025-characterisation.pdf) | Submitted to Antonie van Leeuwenhoek, pending peer review |
| Auditing bacterial dark-gene screens for superimposed open reading frame artefacts: a multi-layer analysis of Rv2438A in *Mycobacterium tuberculosis* | Rv2438A entered this program as a candidate therapeutic target: a small, essential, robustly vulnerable hypothetical protein. Multi-layer re-analysis shows it is, in all likelihood, not a protein-coding gene at all, but a putative open reading frame superimposed on the opposite strand of the essential locus *nadE*. The manuscript turns this negative result into a methodological one: a superimposed ORF over an essential gene satisfies the standard criteria of a bacterial dark-gene screen (essentiality, vulnerability, no assigned function) better than a genuine small gene does, and proposes checks to catch this artefact before it reaches a candidate list. | [PDF](manuscripts/Rv2438A-orf-artefact.pdf) | Submitted to mSystems, pending peer review |

### Antimicrobial resistance

| Title | Description | Access | Status |
|-------|-------------|--------|--------|
| Genomic emergence of resistance to the BPaL/BPaLM regimen across the *Mycobacterium tuberculosis* complex: standing pocket variation versus drug-era determinants | The WHO-recommended BPaLM regimen depends on two drugs whose resistance is poorly catalogued, pretomanid especially. Using a consolidated mutation catalogue and a 132,609-strain variant pangenome, this manuscript maps where, when and in which lineages BPaLM resistance arises, discovers F420-pathway pretomanid-resistance candidates phenotype-free by phylogenetic convergence (triangulated with structural localisation in the F420 cofactor pocket and ESM-1v scoring), and shows they are standing polymorphisms that predate the drugs rather than drug-era-selected determinants. Literature mining independently corroborates the F420 pathway as a drug-inducible resistance route and surfaces a fourth, DST-anchored candidate; a compensatory-background analysis serves as a negative control. | [PDF](manuscripts/bpal-resistance-emergence.pdf) | Draft, pending peer review |
